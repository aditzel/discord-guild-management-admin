 ...
 * @author Dave Syer
 */
public class DiscordClientCredentialsAccessTokenProvider extends OAuth2AccessTokenSupport implements AccessTokenProvider {
    ...
    public OAuth2AccessToken obtainAccessToken(OAuth2ProtectedResourceDetails details, AccessTokenRequest request)
        ...
        return retrieveToken(request, resource, getParametersForTokenRequest(resource), getDefaultHttpHeaders());
